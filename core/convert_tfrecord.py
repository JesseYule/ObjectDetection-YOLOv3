...
def main(argv):
    ...
    parser.add_argument("--dataset_txt", default='../data/voc_data/new_train.txt')
    parser.add_argument("--tfrecord_path_prefix",
                        default='../data/voc_data/images')
    # default='./data/raccoon_data/quick_train_data/tfrecords/quick_train_data')
