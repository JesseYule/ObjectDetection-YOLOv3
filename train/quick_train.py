...
test_tfrecord = "../data/voc_data/images_test.tfrecords"
...
# 这个要根据实际情况修改
saver_to_restore.restore(sess, "../checkpoint/cpk-1")
...
for step in range(STEPS):
    ...
    # 保存模型
    if (step + 1) % SAVE_INTERNAL == 0: saver.save(sess, save_path="../checkpoint/cpk",
                                                   global_step=step + 1)
